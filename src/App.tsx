...
function App() {
  ...
  return (
    <div className='flex flex-col sm:flex-row w-[100%] h-full relative'>
      <div className={`w-[150px] h-full lg:h-auto absolute top-0 duration-300 z-10 ${menuOpen ? 'left-0 shadow-[0_30px_50px_5px_rgba(0,0,0,0.3)]' : '-left-[200px]'} lg:shadow-none lg:static lg:w-[15%] bg-zinc-100/40 backdrop-blur-xl lg:bg-zinc-300 px-4 3xl:p-6`}>
